...
void adios_mpi_comp_init (const PairStruct * parameters
                    ,struct adios_method_struct * method
                    )
{
    struct adios_MPI_COMP_data_struct * md = (struct adios_MPI_COMP_data_struct *)
                                                    method->method_data;
    if (!adios_mpi_comp_initialized)
    {
        adios_mpi_comp_initialized = 1;
    }
    method->method_data = malloc (sizeof (struct adios_MPI_COMP_data_struct));
    md = (struct adios_MPI_COMP_data_struct *) method->method_data;
    md->fh = 0;
    md->req = 0;
...
int adios_mpi_comp_open (struct adios_file_struct * fd
